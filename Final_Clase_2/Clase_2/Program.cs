            ...
            do
            {
                ...
                switch(key)
                {
                    case 1:
                        ...
                        Console.WriteLine(Calculador.Acumulador(Console.ReadLine()));//Conversor.BinarioEntero(Console.ReadLine()));
                        Console.ReadKey();
                        break;
                    case 2:
                        ...
                        Console.WriteLine(Calculador.getResultadoBinario());//(Conversor.EnteroBinario(converso));
                        else
